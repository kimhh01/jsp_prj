...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<ul class="navbar-nav me-auto mb-2 mb-md-0">
						...
						<li class="nav-item"><a class="nav-link" href="#void">이전으로</a></li>
  ...
  ================================================== -->
			...
			<div class="row featurette">
				...
				<div>
				<%
				// input type ="text"는 값이 입력되지 않으면 queryString으로 ""가 입력되어 생성된다. 
				String[] text = request.getParameterValues("text");
				// 체크박스는 확인된 것이 없으면 queryString 자체가 생성되지 않으므로 null이 입력됨 
				...
				for (int i=0; i<hobby.length; i++){
					...
					out.println("<strong>선택된 취미가 없음</strong><br>");
				}
				%>
					<%= java.util.Arrays.toString(text) %>
					<%= java.util.Arrays.toString(hobby) %>
 				<br>
				</div>
				<br>
				</div>
